...

{
    ...
    {
        $accessToken = env('SQUARE_ACCESS_TOKEN', 'EAAAECgleBpIn82MXut9LcZ9iL02-BKsYdjG5YN0tBumJfN_U8xEeJqDF9bNqIyi');
        $this->locationId = env('SQUARE_LOCATION_ID', 'L9SN0T1XWTC84');
    ...
    public function addCustomer($cardName)
    {
    ...
    public function addCard(Request $request)
    {
        ...
        $customersApi = new \SquareConnect\Api\CustomersApi($this->defaultApiClient);
        $customerId = $this->addCustomer($cardName);
        ...
        $this->charge($customerId, $card_id,$cardAmount );


        return redirect()->back();

    }
    public function charge($customerId, $cardId,$cardAmount)
    {
        ...
        # Monetary amounts are specified in the smallest unit of the applicable currency.
        # This amount is in cents. It's also hard-coded for $1.00, which isn't very useful.
        $amountMoney->setAmount((int)$cardAmount);
        $amountMoney->setCurrency("USD");
